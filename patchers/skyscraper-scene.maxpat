...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 505.0, 44.0, 73.0, 20.0 ],
					"text" : "textures"
				}
...
,
					"patching_rect" : [ 505.0, 79.0, 48.0, 22.0 ],
					"saved_object_attributes" : 					{
						"accentcolor" : [ 0.498039215686275, 0.498039215686275, 0.498039215686275, 1.0 ],
						"description" : "",
						"digest" : "",
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 13.0, 159.0, 650.0, 36.0 ],
					"text" : "jit.gl.model scene @file skyscraper-base.obj @shader pbr-example @texture height-rocks albedo-rocks roughness-rocks normal-rocks ao-rocks @position 0 1 0 @scale 0.2 @lighting_enable 1 @position 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 117.5, 286.473087818696854, 540.0, 50.0 ],
					"text" : "jit.gl.model scene @file skyscraper-glass.obj @shader pbr-example @texture col-windows met-windows nrm-windows rgh-windows @position 0 1 0 @scale 0.2 @lighting_enable 1 @position 0 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 293.5, 243.473087818696854, 150.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 11.0, 52.0, 256.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 17.0, 73.0, 20.0 ],
					"text" : "skyscraper"
				}
