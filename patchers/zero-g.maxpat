...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 101.0, 17.0, 204.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 13.0, 77.0, 256.0, 22.0 ],
					"text" : "jit.phys.ghost @shape sphere @force 50 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 381.0, 93.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 324.0, 126.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 324.0, 59.0, 100.0, 22.0 ],
					"text" : "jit.phys.body"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 13.0, 17.0, 94.0, 20.0 ],
					"text" : "Zero Gravity"
				}
